...
test('Should create post for user', async () => {
    const response = await request(app)
        ...
        .field('destination', 'Gunung Slamet')
        .field('description', 'Ayo jalan-jalan!')
        .field('route', 'Sleman-Magelang-Temanggung-Wonosobo')
        .field('capacity', '5')
        .field('start', '2019-05-18T16:00:00.000Z')
        .field('finish', '2019-06-18T16:00:00.000Z')
        .attach('image', 'tests/fixtures/gunung-slamet.jpg')
        .expect(201)
